var DotPHTP = function(){
	...
	$(function() {
		...
		$('.ACTIONS').on('click', '#btnAddNew', function () {
			that.oDialog.show('Thêm Đợt phát hành trái phiếu', 'DotPHTPCT', '80%', '500px');
		});		
		$('.ACTIONS').on('click', '#btnLichTra', function () {
			that.oDialog.show('Lịch trả đợi phát hành trái phiếu', 'DotPHTPLichTra', '80%', '500px');
		});	
